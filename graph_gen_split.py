...
# map additional demographic info
...
if sex_col:
    sex_map = df_meta.set_index('RegistrationCode')[sex_col].astype('category').cat.codes.to_dict()
else:
    sex_map = {}

if bmi_col:
    bmi_map = df_meta.set_index('RegistrationCode')[bmi_col].astype(float).to_dict()
else:
    bmi_map = {}
